...
import { createMovie, uploadFile } from '../api/movies-api'
...
export class CreateMovie extends React.PureComponent<
  CreateImageProps,
  CreateImageState
  > {
  ...
  handleSubmit = async (event: React.SyntheticEvent) => {
    ...
    try {
      ...
      const uploadInfo = await createMovie(this.props.auth.getIdToken(), {
        genreId: this.props.match.params.groupId,
